...
vi.mock('@/_components/AnimatedBackground', () => ({
...
vi.mock('@/_components/PageHeader', () => ({
...
describe('PortfolioClient', () => {
  ...
  it('should handle card click and open modal', async () => {
    ...
    const cardButtons = screen.getAllByText(/View details for/);
  ...
  it('should handle empty portfolio items array', () => {
    ...
    expect(screen.queryByText(/View details for/)).not.toBeInTheDocument();
  });
});
